...
#This is the csv file with the list of cities to place in the file replace the foler and file path of this file
...
Foreach($city in $NewCityList)
{
    ...
    #Exports the content into a new csv file named whatever the new city is -export.csv
    $csvwebfile|export-csv C:\Projects\Kova\$newcitylower-export.csv -NoTypeInformation
}